...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Ch1xLZ81.js
var router_Ch1xLZ81_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-Q7Zg-U2a.css";
var APP_NAME = "时感";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "时感：让 AI 随时知道现在的日期与时间，以及每次对话之间隔了多久。"
			},
			{
				name: "theme-color",
				content: "#0b0b0c"
...
var $$splitComponentImporter = () => import("./routes-BVvNussY.mjs");
...
//#endregion
export { getRouter, router_Ch1xLZ81_exports as t };
