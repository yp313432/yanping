...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BnzWQzgD.mjs");
...
var manifest = { "c67f7e6148342ce2704eb7f62873f4911280a00a1094ad54bd6691214436cb3d": {
	functionName: "askTimeAware_createServerFn_handler",
	importer: () => import("./chat-D0cOsm7t.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Ch1xLZ81.mjs").then((n) => n.t),
