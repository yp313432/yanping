...
import { a as toEventHandler, n as HTTPError, r as defineLazyEventHandler, s as NodeResponse, t as H3Core } from "./_libs/h3+rou3+srvx.mjs";
...
var grokOgIdentity = { "site": {
	"title": "时感",
	"card": "custom",
	"description": "让 AI 随时知道现在的日期与时间，以及每次对话之间隔了多久。",
	"image": "/og.jpg"
} };
//#endregion
...
var _lazy_fnf7Ww = defineLazyEventHandler(() => import("./_routes/mcp.mjs"));
var _lazy_ETS_6x = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const $0 = {
		route: "/mcp",
		handler: _lazy_fnf7Ww
	}, $1 = {
		route: "/**",
		handler: _lazy_ETS_6x
	};
	return (m, p) => {
		if (p.charCodeAt(p.length - 1) === 47) p = p.slice(0, -1) || "/";
